...
defineOptions({ name: "MemoryTabReview" });
    ...
    <div class="card p-4">
      <div class="flex flex-wrap items-end gap-3">
        ...
        <span class="text-xs text-surface-400 ml-auto self-end pb-1">
          {{ data?.page_info?.total_items ?? 0 }} 条审核项
        </span>
      </div>
    </div>
        ...
        <div class="space-y-3">
          ...
          <div class="flex gap-2">
            <button
              ...
              @click="handleApprove"
            >
              <svg v-if="approveMutation.isPending" class="h-3.5 w-3.5 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
              ...
              {{ approveMutation.isPending ? "审批中..." : "批准" }}
            </button>
            <button
              ...
              @click="handleReject"
            >
              <svg v-if="rejectMutation.isPending" class="h-3.5 w-3.5 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
