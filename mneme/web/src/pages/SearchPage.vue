      ...
      <div class="flex flex-wrap items-end gap-3">
        ...
        <div class="flex flex-col gap-1">
          ...
          <input
            ...
            type="text"
            placeholder="UUID..."
            class="rounded-lg border border-surface-200 bg-white px-3 py-2 text-sm font-mono text-surface-700 placeholder-surface-400 focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 w-60"
          />
        </div>
